...
<template>
  <div class="ordstriden-container">
    ...
    <p v-else-if="correctAnswers >= 7">
      <span class="styled">Du har {{ correctAnswers }} rätt!</span><br>Bra jobbat! 👏<br>Du behöver jobba vidare på följande ord:
    </p>
    <p v-else>
      <span class="styled">Du hade {{ correctAnswers }} rätt.</span><br>Fortsätt kämpa! 💪<br>Du behöver jobba vidare på följande ord:
    </p>
